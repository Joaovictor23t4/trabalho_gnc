  ...
  <header id="header">
    <nav id="nav">
      <div id="nav-principal">
        <div id="bloco1">
          <router-link to="/"><img src="/src/assets/images/gnc-logo-2.png" alt="" id="logo"></router-link>
          <div id="container-shopping" v-show="pathAtual !== '/tela-filme'">;
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" id="icon-shopping" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
        ...
        <div id="bloco2">
              <div id="container-search">
                ...
                <span>
                  <svg xmlns="http://www.w3.org/2000/svg" id="icon-search" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
        ...
        <div id="bloco3">
          <div id="container-usuario">
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" id="icon-user" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
